    ...
    <>
      ...
      <section className={`max-w-[1700px] mx-auto w-full pt-4 pb-0 md:py-8 transition-colors duration-300 ${isDarkMode ? '' : ''}`}>
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 lg:items-stretch mb-0 md:mb-12 md:px-14">
          {/* MAP COLUMN */}
          <div style={{ minHeight: mapHeight }} className={`lg:col-span-8 relative rounded-none md:rounded-2xl overflow-visible md:overflow-hidden shadow-2xl md:!h-[450px] lg:!h-[550px] flex flex-col transition-colors duration-300 ${
