        ...
        <div className="px-3 md:px-14 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-2 md:mb-8">
          <div className="space-y-1 md:space-y-3">
            ...
            <h2 className={`text-[28px] md:text-[32px] lg:text-[40px] font-black leading-tight tracking-tight uppercase ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
              <span className="hidden md:inline">Eiendomsinnsikt </span><span className="md:hidden"><span className="font-bold">Boligmarkedet {getPreposition(selectedDistrict.name)}</span><br/><span className="italic text-blue-500">{selectedDistrict.name.replace(' (Totalt)', '')} nå</span></span><span className="hidden md:inline text-blue-500">{selectedDistrict.name.replace(' (Totalt)', '')}</span>
            </h2>
